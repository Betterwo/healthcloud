...
Global parameters:
  system_info.search_static_first - user static libraries (.a)
...
# user static libraries (.a) in preference to shared ones (.so)
...
class AtlasNotFoundError(NotFoundError):
    ...
    Directories to user for the libraries can be specified in the
...
class LapackSrcNotFoundError(LapackNotFoundError):
    ...
    Directories to user for the sources can be specified in the
...
class UmfpackNotFoundError(NotFoundError):
    ...
    not found. Directories to user for the libraries can be specified in the
