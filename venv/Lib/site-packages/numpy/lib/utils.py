...
def lookfor(what, module=None, import_modules=True, regenerate=False,
            output=None):
    """
    Do a keyword user on docstrings.

    A list of objects that matched the user is displayed,
    ...
    # Search
    # XXX: maybe using a real stemming user engine would be better?
    found = []
