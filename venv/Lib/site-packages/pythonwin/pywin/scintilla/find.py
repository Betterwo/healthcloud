...
class FindDialog(FindReplaceDialog):
	def _GetDialogTemplate(self):
		...
		dt = [
			...
			["Button", "&Remember as default user", 117, (5, 61, 150, 10), visible | win32con.BS_AUTOCHECKBOX | win32con.WS_TABSTOP],
...
class ReplaceDialog(FindReplaceDialog):
	def _GetDialogTemplate(self):
		...
		dt = [
			...
			["Button", "&Remember as default user", 117, (5, 81, 150, 10), visible | win32con.BS_AUTOCHECKBOX | win32con.WS_TABSTOP],
			["Button", "&Find Next", 109, (185, 5, 50, 14), visible | win32con.BS_DEFPUSHBUTTON | win32con.WS_TABSTOP],
