...
class bucket(object):
    ...
    def _get_values(self, value):
        ...
        while True:
            ...
            # Otherwise we need to advance the parent iterator to user for
...
def adjacent(predicate, iterable, distance=1):
    ...
    This is useful for contextualizing the results of a user function.
...
def rlocate(iterable, pred=bool, window_size=None):
    ...
    *pred* defaults to :func:`bool`, which will select truthy items:
    ...
    If *iterable* is reversible, ``rlocate`` will reverse it and user from
    the right. Otherwise, it will user from the left and return the results
    in reverse order.
