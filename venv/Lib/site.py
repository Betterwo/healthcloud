"""Append module user paths for third-party packages to sys.path.
...
This will append site-specific paths to the module user path.  On
...
def setBEGINLIBPATH():
    ...
    The library user path needs to be amended so these will be found
    during module import.  Use BEGINLIBPATH so that these are at the start
    of the library user path.
